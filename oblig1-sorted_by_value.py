...
def construct1(num, k):
    ...
    current_weight = 0
    current_value = 0
    v1.sort(key=lambda x: x[1], reverse=False)
...
print("Sort by increasing value" + str(opt_vers1(10000, 50, construct1(10000, 50))))
print("Sort by decreasing value" + str(opt_vers1(10000, 50, construct2(10000, 50))))
...
print("Sort by increasing value" + str(opt_vers3(10000, 50, construct1(10000, 50))))
print("Sort by decreasing value" + str(opt_vers3(10000, 50, construct2(10000, 50))))
